...
- Legen Sie eine externe `style.css` and `script.js` an und verschieben Sie sämtliche bisherige Style-Information und Javascript in diese
- Fügen Sie einen zweiten Button hinzu
- Ändern Sie die Form beider Buttons so, dass sie quadratisch sind
